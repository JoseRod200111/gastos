...
export default function VehiculosPage() {
  ...
  const cargarViajes = useCallback(async () => {
    ...
    let q = supabase.from('viajes').select('*').order('id', { ascending: false })
    ...
    setLoading(false)
  }, [fId, fVehiculo, fDesde, fHasta, fBuscar])
  ...
  useEffect(() => {
    ...
    const dias =
      Math.max(
        1,
        Math.round((fin.getTime() - ini.getTime()) / (1000 * 60 * 60 * 24)) + 1
      )
  ...
  const seleccionarViaje = async (v: Viaje) => {
    ...
    setForm({
      ...
      combustible_inicial:
        v.combustible_inicial != null ? String(v.combustible_inicial) : '',
      combustible_final:
        v.combustible_final != null ? String(v.combustible_final) : '',
      combustible_despachado:
        v.combustible_despachado != null ? String(v.combustible_despachado) : '',
      ...
      consumo_por_galon:
        v.consumo_por_galon != null ? String(v.consumo_por_galon) : '',
    })
  ...
  const guardarViaje = async () => {
    try {
      ...
      const payload = {
        ...
        combustible_inicial:
          form.combustible_inicial !== '' ? Number(form.combustible_inicial) : null,
        combustible_final:
          form.combustible_final !== '' ? Number(form.combustible_final) : null,
        combustible_despachado:
          form.combustible_despachado !== ''
            ? Number(form.combustible_despachado)
            : null,
        precio_galon: form.precio_galon !== '' ? Number(form.precio_galon) : null,
        salario_diario:
          form.salario_diario !== '' ? Number(form.salario_diario) : null,
        dias: form.dias !== '' ? Number(form.dias) : null,
        observaciones: form.observaciones || null,
        km_recorridos:
          form.km_recorridos !== '' ? Number(form.km_recorridos) : null,
        consumo_por_galon:
          form.consumo_por_galon !== '' ? Number(form.consumo_por_galon) : null,
      }
          ...
          <div className="grid gap-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, combustible_inicial: e.target.value })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, combustible_final: e.target.value })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, combustible_despachado: e.target.value })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, km_recorridos: e.target.value })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, consumo_por_galon: e.target.value })
                }
          ...
          {!viajeSel ? (
            ...
            <>
              <div className="grid gap-2 mb-3">
                ...
                >
                  {guardandoGasto ? 'Registrando...' : 'Registrar'}
                </button>
              </div>
